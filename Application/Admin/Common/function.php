...
// 获取发现中的状态操作
function theme_status_op($status) {
    switch ($status){
        case 0  : return    '推荐';     break;
        case 1  : return    '取消推荐';     break;
        default : return    false;      break;
    }
}
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_notify_type($type = null){
    if(!isset($type)){
        return false;
    }
    switch ($type){
        case 1  : return    '通知'; break;
        case 2  : return    '自定义消息'; break;
        default : return    false;  break;
    }
}
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_platform_type($type = null){
    if(!isset($type)){
        return false;
    }
    switch ($type){
        case 1  : return    'Android,IOS'; break;
...
function get_license_type($type = null){
    ...
    switch ($type){
        case 1  : return    '普通营业执照,组织机构代码证'; break;
        case 2  : return    '三证合一营业执照'; break;
        default : return    false;  break;
    }
}
 ...
 * 返回平台来源
 * @param intger $type 类型
 * @param bool $all 是否返回全部来源
 */
function get_source_type($type, $all = false){
	$list = array(
		0 => 'PC平台',
		1 => 'Android平台',
		2 => 'IOS平台',
 ...
 */
function get_account_type($type, $all = false){
	$list = array(
		0 => '冻结',
		1 => '正常'			
	);
