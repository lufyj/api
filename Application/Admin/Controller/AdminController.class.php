...
class AdminController extends Controller {
    ...
    protected function _initialize(){
        ...
        if(!IS_ROOT){
        	//判断方法是不是以ajaxGet
        	if(strpos(ACTION_NAME, 'ajaxGet') === false){
        ...
        $this->assign('__MENU__', $this->getAceMenus());
    }
     ...
     */
    final public function getAceMenus($controller=CONTROLLER_NAME){
    	...
    	if(empty($menus)){
    		...
    		session('ADMIN_MENU_LIST',$menus);//.$controller
    	}
    	return $menus;
    }
    /**
    ...
    /* 获取分类集合 */
    protected function getCates($more = true){
