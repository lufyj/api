...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            if(params.valueTo){
              this.finishs = document.querySelector(params.finishs);
        ...
        finish: function(e) {
            ...
            _self.finishs.innerHTML = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
             _self.finish.innerHTML = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            if(this.valueTo){
                this.valueTo.value= provinceCode +((cityCode)?(',' + cityCode):('')) + ((countyCode)?(',' + countyCode):(''));
                this.finishs.innerHTML = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            }
            _self.close(e);
        },
        close: function(e) {
